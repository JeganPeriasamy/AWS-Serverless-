...
function submitForm(formData) {
  ...
  fetch('https://l6y4fdrzii.execute-api.eu-north-1.amazonaws.com/prod/submit', { // URL that represents the backend API endpoint to which the form data is going to be sent
    method: 'POST',
    headers: {
